...
import threading
import pandas as pd
from . import lastprice,DBhost,DBport1,fetchins
...
# investor = '008107'
#我的
# investor = '192542'  ##日度  #  New112018#
investor = '202021'  ##tick  #   Newconcept#
pwd = 'Newconcept#'
# pwd = '1'
...
class MyQuote(object):
    ...
    def __init__(self, addr: str, broker: str, investor: str, pwd: str):
        ...
        # print(fetchins.get('data'))
        # self.q.OnUserLogin = lambda o, i:self.q.ReqSubscribeMarketData(fetchins.get('data'))#, self.q.ReqSubscribeMarketData('sa2201')
        self.flag=False
...
#         self.con.connect('server.natappfree.cc,38815,'admin','123456')
        self.con.connect(DBhost,DBport1,'admin','123456',highAvailability=False)
    ...
    def to_dolphin(self):
        while 1:
            ...
            # print(good[["Instruments","time","开盘价","最高价","最低价","最新价"]].head(50))
            #
            try:
    ...
    def release(self):
        ...
        self.flag=True
        sys.exit(0)
MyTradeonj = MyTrade(front_trade, broker, investor, pwd, appid, auth_code)
MyTradeonj.run()
VolumeMultiple=MyTradeonj.t.instruments
...
def CTPmarketfetch():
    ...
    # tt.run()
    while not MyTradeonj.t.logined:
        time.sleep(3)
    print('account info')
    print(MyTradeonj.t.account)
    # MyTradeonj.t.ReqOrderInsert()
    print(len(MyTradeonj.t.instruments))
